...
// 쇼핑커넥트 모드 전용 정보 확인 문구. 시점성 할인·재고·순위 주장은 금지한다.
export const SHOPPING_HOOKS = [
    '가격과 옵션은 결제 전에 한 번 더 확인해보세요.',
    '상세 규격이 필요한 용도와 맞는지 확인해보세요.',
    '구성품과 모델 번호를 상품 페이지에서 확인해보세요.',
    '실구매 후기와 Q&A를 함께 보면 판단하기 편해요.',
    '배송과 교환 조건은 판매자 안내에서 확인해보세요.',
    '현재 판매 조건은 상품 페이지에서 다시 확인할 수 있어요.',
];
