...
■ 글 구조 (필수 준수):
  1. 도입: 작은 장면/오해/불편/의외의 반응 중 하나로 시작해 첫 3문장 안에 읽을 이유를 만든다.
  2. 중반: 공감만 반복하지 말고, 구체 장면 → 반전/비교 → 판단 → 저장할 포인트 순서로 밀고 간다.
  3. 후반: 한 줄 요약 + 댓글로 답하고 싶은 질문 또는 저장/공유할 이유를 남긴다.
...
■ 필수 요소:
  - 스크롤 정지 문장 1개: "여기서 손이 멈춘 이유"가 보여야 함
  - 저장 가치 1개: 체크리스트, 비교 기준, 주의점, 한 줄 판정 중 하나
  - 댓글 유도 1개: 막연한 "어떠세요?"가 아니라 선택지나 경험 회수형 질문
  - 관찰 가능한 디테일 1개: 시간대/장면/반응/수치/표현 중 자료에 있는 것만 사용
