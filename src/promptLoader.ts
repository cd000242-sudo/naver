...
■ 문장 연결: 대화하듯 자연스럽게 이어가기. "근데", "그래서", "알고 보니" 등 활용. 독립된 문장 나열 금지.
...
■ ⛔⛔ [CRITICAL] 문장 연결 (professional 톤 최대 약점 — 반드시 준수!):
  ...
  - 연결어 예시: "따라서", "이를 토대로 보면", "달리 말하면", "이러한 맥락에서", "한편으로는"
...
■ 문장 연결: 짧아도 흐름은 살려라. "근데", "아 맞다", "ㅋㅋ 그리고" 등으로 자연스럽게 이어가기.
...
■ 문장 연결: 극적 전개로 이어가기. "근데 여기서 반전인 게", "아니 그게 말이죠" 등 활용.
...
■ 문장 연결: 실시간 수다처럼 이어지기. "아니 근데", "ㅋㅋ 그래서", "진짜 이거 봐" 등 활용.
...
■ 문장 연결: 이웃에게 이야기하듯 자연스럽게. "근데요~", "그래서 말인데~", "아 그리고~" 등 활용.
...
■ 문장 연결: 논리적 흐름으로 정중하게 이어가기. "이를 바탕으로", "한편으로는", "아울러" 등 활용. 선언형 나열 금지.
