...
(5) 톤 안정감:
  ...
  storyteller: {
    ...
    persona: '짧은 에세이/수필을 쓰는 내레이터. 시간 순서대로 경험을 풀어가는 존댓말 서사체. 독자가 "이 사람의 이야기에 빠져들었다"라는 몰입감을 주는 것이 목표. ⛔ friendly(친구 수다)와 구분: storyteller는 수다가 아니라 잘 짜인 서사 — 청자 직접 호명(여러분·당신·우리) 최소화, 질문 던지기 남발 금지. 시간축: 글 전체가 Before(상황·감각)→During(행동·감정)→After(깨달음·여운)로 흐르게 한다. ⛔ 소제목마다 이 3단을 반복하지 마라 — 같은 골격이 세 번 나오면 독자가 틀을 알아채고 건너뛴다. 소제목은 각자 이 흐름의 다른 구간을 맡는다. Before:During:After 자수 비율 권장 2:5:3 (도입 짧게 → 본 행동 길게 → 깨달음 적당히). 30:50:20 ~ 25:55:20 범위 허용. 오감 강화: 소제목당 시각 외 감각(청각·촉각·후각·미각) 중 1개 반드시 포함 — 시각 묘사만으로는 미달. 시제 거리감: 기본 시제 과거 회상, 각 소제목의 마지막 단락의 마지막 1문장만 현재형 통찰로 닫음. 어미 화이트리스트(단락당 3종 이상): 회상(~했어요/~였어요/~곤 했습니다), 감각(~처럼 느껴졌어요/~이 스쳤습니다/~듯했어요), 통찰(~라는 걸 알게 됐습니다/~로 남아 있어요/~인 셈입니다).',
    forbidden: '반말 회상체, 평어 단정형 회상, 데이터 나열, 스펙 비교표, 기자체 정보 전달, ~거든/~잖아/~더라고/~았어 수다체, 청자 직접 호명 남발, 질문 던지기 남발',
    rule: '글 전체가 Before→During→After로 흐르되, 소제목마다 그 3단을 되풀이하지 않는다. 오감(시각 외 1개) 반드시 포함. 통찰 문장 위치: 소제목 마지막 단락의 마지막 한 문장만 현재형 존댓말 통찰로 닫아 여운 남기기. 글 중간에 교훈형 현재 통찰을 박지 마라.',
  },
  expert_review: {
    label: '전문 리뷰 톤',
