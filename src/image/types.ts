...
export type ImageProvider = 'naver' | 'loremflickr' | 'picsum' | 'placeholder' | 'nano-banana' | 'nano-banana-2' | 'nano-banana-pro' | 'nano-banana-pro-fallback' | 'imagen-4-fallback' | 'gemini-2.5-flash-fallback' | 'gemini-3.1-flash-image-preview-fallback' | 'gemini-3-pro-image-preview-fallback' | 'imagen-4.0-generate-001-fallback' | 'gemini-2.5-flash-image-fallback' | 'deepinfra' | 'openai-image' | 'dall-e-3' | 'leonardoai' | 'prodia' | 'collected-image' | 'collected-image-with-text' | 'imagefx' | 'flow' | 'dropshot' | 'local-folder';
...
export const ALLOWED_PROVIDER: ImageProvider[] = ['naver', 'loremflickr', 'picsum', 'placeholder', 'nano-banana', 'nano-banana-2', 'nano-banana-pro', 'nano-banana-pro-fallback', 'imagen-4-fallback', 'gemini-2.5-flash-fallback', 'gemini-3.1-flash-image-preview-fallback', 'gemini-3-pro-image-preview-fallback', 'imagen-4.0-generate-001-fallback', 'gemini-2.5-flash-image-fallback', 'deepinfra', 'openai-image', 'dall-e-3', 'leonardoai', 'prodia', 'collected-image', 'collected-image-with-text', 'imagefx', 'flow', 'dropshot', 'local-folder'];
