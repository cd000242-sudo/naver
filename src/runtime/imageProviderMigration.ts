 ...
 *   기본 모델 키 'gemini-3-1-flash'(= gemini-3.1-flash-image-preview)를 호출했다.
 *   v2.10.335부터 'nano-banana-pro'는 "나노바나나 프로"(gemini-3-pro-image-preview, 고가)를
 ...
 *   gemini-3.1-flash-image-preview로 라우팅되어 동작이 보존되기 때문이다.
 */
