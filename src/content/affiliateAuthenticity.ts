...
- 각 핵심 문단은 "후기에서 확인된 구체 상황 → 실제 사용 결과·해결·적응 또는 남은 한계 → 왜 구매 전에 중요한지 → 어떤 사람에게 맞고 안 맞는지" 순서로 쓴다.
...
- 각 핵심 흐름은 후기에서 확인된 실제 불편 → 후기 원문에서 확인된 사용 뒤 결과 → 그 결과가 구매 이유가 되는 사람과 조건 순서로 쓴다.
