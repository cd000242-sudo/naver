    ...
    images: `
      <div style="line-height: 1.8; color: var(--text-strong);">
        ...
        <ol style="padding-left: 1.5rem; margin-bottom: 1.5rem;">
          ...
          <li style="margin-bottom: 1rem;">
            <strong>3단계: 이미지 소스 선택</strong><br>
            <span style="color: var(--text-muted);">"이미지 소스"에서 ImageFX·Flow(Google Labs, 계정/IP 제한 가능) / Nano Banana Pro·Leonardo·DeepInfra(유료) / 내 폴더를 선택하세요. 장기 발행은 실제 생성 테스트가 통과한 엔진을 선택하세요.</span>
          </li>
          <li style="margin-bottom: 1rem;">
