...
async function generateAIImagesForHeadings(headings, formData, structuredContentSnapshot) {
    ...
    const generateOne = async (heading, i) => {
        try {
            ...
            // [2026-09-06 R-A] Viewpoint is owned by main's contextual brief (imageGenerator
            // mappedItems) keyed on `diversityIndex`; the renderer no longer appends a camera line.
