...
1. **Tone Sync (${toneStyle}):**
   ...
   - **Casual:** "이거 찐임. 강추.", "솔직히 이 가격에 이 정도면 갓성비" (산뜻형)
   - **Formal:** "해당 제품의 성능을 안내드리겠습니다." (격식형)
   - **Humorous:** "가격 보고 눈물이 났는데 성능 보고 또 울었어요(감동)." (위트형)
   - **Community_fan:** "아니 이거 실화냐... 다들 난리거든요ㅠ" (커뮤니티형)
   - **Mom_cafe:** "맘들~~ 이거 써보니까 진짜 달라요^^" (맘카페형)
   - **Storyteller:** "처음 박스를 열었을 때, 솔직히 별감흥이 없었어요." (서사형)
   - **Expert_review:** "테스트 결과 전작 대비 23% 향상된 수치입니다." (평가형)
   - **Calm_info:** "이 부분만 체크하시면 충분해요." (안내형)
2. **Time Sync:**
