...
export const CONTENT_QUALITY_V3_CANDIDATE_RUNTIME_SOURCE_PATHS: readonly string[] = Object.freeze([
  ...
  'src/generation/connectionConfig.ts',
  'src/generation/mcp/connectionMaterialStore.ts',
  'src/generation/mcp/contracts.ts',
  'src/generation/mcp/imageAdapter.ts',
  'src/generation/mcp/index.ts',
  'src/generation/mcp/registry.ts',
  'src/generation/mcp/runtime.ts',
  'src/generation/mcp/runtimeService.ts',
  'src/generation/mcp/sdkClientFactory.ts',
  'src/generation/mcp/textAdapter.ts',
  ...
  'src/renderer/modules/generationConnectionUI.ts',
