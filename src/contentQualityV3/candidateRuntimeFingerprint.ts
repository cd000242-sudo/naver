...
export const CONTENT_QUALITY_V3_CANDIDATE_RUNTIME_SOURCE_PATHS: readonly string[] = Object.freeze([
  ...
  'src/agentCli/detectResilience.ts',
  ...
  'src/content/situationDepthContract.ts',
  'src/content/situationTitleContract.ts',
  'src/content/sourceFactChecklist.ts',
  'src/content/sourceFidelityCheck.ts',
  'src/content/sourceFreshness.ts',
  'src/content/sourceMaterialAudit.ts',
  ...
  'src/prompts/shared/fact-brief-header.prompt',
  'src/prompts/shared/hashtag-strategy.prompt',
  'src/prompts/shared/headings-homefeed.prompt',
  'src/prompts/shared/headings-seo.prompt',
