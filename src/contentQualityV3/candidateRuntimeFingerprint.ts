...
export const CONTENT_QUALITY_V3_CANDIDATE_RUNTIME_SOURCE_PATHS: readonly string[] = Object.freeze([
  ...
  'src/analytics/searchKeyword.ts',
  ...
  'src/content/crossSectionRepetition.ts',
  ...
  'src/content/futureDatedPastClaim.ts',
  'src/content/generalContentGuard.ts',
  'src/content/generationModeStamp.ts',
  'src/content/generationSourceBuilder.ts',
  ...
  'src/content/outputTruncation.ts',
  'src/content/paraphraseSourceAnalysis.ts',
  'src/content/paraphraseUpgradeBlock.ts',
  'src/content/personaBuilder.ts',
  'src/content/pipelineIntegrityGate.ts',
  'src/content/pipelineMetricLeak.ts',
  'src/content/postDraftFactCheck.ts',
  'src/content/postProcessTrace.ts',
  ...
  'src/content/titleAnswerRetry.ts',
  ...
  'src/image/fullAuto/fullAutoImageAsset.ts',
  'src/image/fullAuto/fullAutoImagePolicy.ts',
  'src/image/fullAuto/fullAutoImageRequest.ts',
  'src/image/fullAuto/fullAutoImageRunner.ts',
  ...
  'src/image/squareImageTarget.ts',
  ...
  'src/main/ipc/paraphraseAnalysisHandlers.ts',
  ...
  'src/prompts/shared/experience-contract.prompt',
  ...
  'src/prompts/shared/issue-claim-discipline.prompt',
  ...
  'src/quality/critique/batchEditor.ts',
  'src/quality/critique/claimNormalize.ts',
  'src/quality/critique/claimScanner.ts',
  'src/quality/critique/costLedger.ts',
  'src/quality/critique/critic.ts',
  'src/quality/critique/criticPrompt.ts',
  'src/quality/critique/editorPrompts.ts',
  'src/quality/critique/evidence.ts',
  'src/quality/critique/finalJudge.ts',
  'src/quality/critique/flag.ts',
  'src/quality/critique/generatorHook.ts',
  'src/quality/critique/hashtagProvenance.ts',
  'src/quality/critique/issueLedger.ts',
  'src/quality/critique/issuePropagation.ts',
  'src/quality/critique/issueTaxonomy.ts',
  'src/quality/critique/issueValidator.ts',
  'src/quality/critique/loopContext.ts',
  'src/quality/critique/metrics.ts',
  'src/quality/critique/orchestrator.ts',
  'src/quality/critique/precheck.ts',
  'src/quality/critique/preservation.ts',
  'src/quality/critique/researchRecovery.ts',
  'src/quality/critique/sectionModel.ts',
  'src/quality/critique/verification.ts',
  'src/quality/generationRunPrune.ts',
  'src/quality/generationRunResume.ts',
  'src/quality/generationRunSourceRanking.ts',
  'src/quality/generationRunStore.ts',
  'src/quotaManager.ts',
  'src/rag/embedder.ts',
  'src/rag/vectorStore.ts',
  'src/renderer/automationHelpers.ts',
  'src/renderer/components/HeadingImageSettings.ts',
  'src/renderer/components/ProgressImageViewer.ts',
  ...
  'src/renderer/modules/collectedImagePreview.ts',
