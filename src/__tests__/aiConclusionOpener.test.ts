...
describe('AI 마무리 여는말 제거', () => {
  it('문단 첫머리의 정리하면/결론적으로/요약하면만 떼고 뒤 문장은 그대로 둔다', () => {
    ...
    // [2026-09-03 클로드코드 실측] "정리해서 말하면 지금 확인할 건 …" — 변형도 같은 마무리 표지다
    expect(stripAiConclusionOpeners('정리해서 말하면 지금 확인할 건 본인이 어느 단계에서 멈춰 있느냐입니다.')).toBe('지금 확인할 건 본인이 어느 단계에서 멈춰 있느냐입니다.');
  });
