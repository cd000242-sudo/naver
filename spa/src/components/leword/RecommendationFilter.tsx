...
export default function RecommendationFilter({ value, onChange, counts, searchOnly = false }: {
    ...
    return <>
        <div className="lw-segment lw-segment-wrap" role="group" aria-label="추천 근거 상태">
            {([
                ['ready', searchOnly ? '검색 근거 통과 후보' : '근거 통과 작성 후보'], ['research', '추가 조사'], ['excluded', searchOnly ? '검색 공략 보류' : '추천 제외 · 보관'],
        ...
        {searchOnly && <p className="lw-write-hint">이 판정은 검색 유입 공략에만 해당합니다. 검색 공략 보류 상품도 ‘신기·실용 상품 발견’에서 확인할 수 있습니다.</p>}
