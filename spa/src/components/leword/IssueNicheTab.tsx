 ...
 *
 * 황금키워드보드와 같은 방식이다: 사장님 CI 가 하루 3회(05·11·17시 KST, 2026-09-15 2시간 앞당김)
...
role="group" aria-label="판정">
            ...
            {status === 'empty' && (
                <div className="lw-note">이번 회차에는 세 실측(검색량 300+ · 데이터랩 최근 7일 수요와 문서수 3,000 이하 · 블로그탭 상위 10 정면글 0건)을 다 통과한 키워드가 없습니다. 다음 회차는 {board?.schedule || '05·11·17시(KST)'} 입니다.</div>
            )}
