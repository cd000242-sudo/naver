import{j as e,f as re}from"./index-DRSYFx9_.js";import{c as d,d as te,L as k}from"./router-BCNeJdl_.js";import{P as oe,g as B,i as ie}from"./pricingSchedule-D-ZZfyYx.js";const R=[{src:"/images/pricing-proof/adsense-10000-month.jpg",title:"이번 달 US$1만",desc:"애드센스 예상 수입 상승 인증",metric:"월 수익"},{src:"/images/pricing-proof/adsense-daily-100.jpg",title:"오늘 US$100+",desc:"일 수익 상승 사례",metric:"일 수익"},{src:"/images/pricing-proof/adsense-28days-931.jpg",title:"최근 28일 US$931",desc:"월간 운영 성과",metric:"28일 성과"},{src:"/images/pricing-proof/adsense-today-95.jpg",title:"오늘 US$95.57",desc:"당일 수익 인증",metric:"당일 수익"},{src:"/images/pricing-proof/adsense-small-start.jpg",title:"작은 블로그도 수익 흐름 확인",desc:"초기 운영 단계의 수익 상승 사례",metric:"시작 사례"}],O=[{src:"/images/proof-user/fast/KakaoTalk_20260305_004700252_07-fast.jpg",title:"방문횟수 9,177 돌파",desc:"2월 15일 기준 방문 지표가 크게 상승한 실제 성과 화면입니다.",metric:"방문 9,177"},{src:"/images/proof-user/fast/KakaoTalk_20260310_002438127-fast.jpg",title:"조회수 19,896 인증",desc:"조회수와 공감수가 함께 쌓인 네이버 운영 성과입니다.",metric:"조회 19,896"},{src:"/images/proof-user/fast/KakaoTalk_20260309_163736774-fast.jpg",title:"조회수 10,003 기록",desc:"발행 후 조회수가 빠르게 누적된 실제 인증 화면입니다.",metric:"조회 10,003"}],h=[...R,...O];function ae({className:t="",compact:l=!1,variant:n="grid"}){const[i,o]=d.useState(0),x=R[0],j=R.slice(1),u=h[i]||h[0];return d.useEffect(()=>{if(n!=="carousel"||h.length<=1||window.matchMedia("(prefers-reduced-motion: reduce)").matches)return;const s=window.setInterval(()=>{o(m=>(m+1)%h.length)},3600);return()=>window.clearInterval(s)},[n]),d.useEffect(()=>{if(n!=="carousel"||h.length<=1)return;const s=h[(i+1)%h.length],m=window.setTimeout(()=>{const f=new Image;f.decoding="async",f.src=s.src},900);return()=>window.clearTimeout(m)},[i,n]),n==="carousel"?e.jsxs("section",{className:`proof-carousel${l?" proof-showcase-compact":""}${t?` ${t}`:""}`,"aria-label":"애드센스와 네이버 성과 자동 슬라이드",children:[e.jsxs("div",{className:"proof-carousel-stage",children:[e.jsxs("div",{className:"proof-carousel-summary",children:[e.jsx("span",{children:u.metric}),e.jsx("strong",{children:u.title}),e.jsx("small",{children:u.desc})]}),e.jsx("div",{className:"proof-carousel-image-shell","aria-live":"polite",children:e.jsx("img",{src:u.src,alt:u.title,loading:"lazy",decoding:"async",className:"proof-carousel-image active"},`${u.src}-${i}`)}),e.jsx("div",{className:"proof-carousel-dots","aria-label":"성과 이미지 선택",children:h.map((s,m)=>e.jsx("button",{type:"button",className:m===i?"active":"","aria-label":`${m+1}번째 성과 보기`,"aria-pressed":m===i,onClick:()=>o(m)},s.src))})]}),e.jsx("style",{children:`
                    .proof-carousel {
                        width: 100%;
                        min-height: 680px;
                        margin: 0;
                ...
                `})]}):e.jsxs("section",{className:`proof-showcase${l?" proof-showcase-compact":""}${t?` ${t}`:""}`,"aria-label":"애드센스와 네이버 성과 인증",children:[e.jsxs("div",{className:"proof-showcase-copy",children:[e.jsx("span",{children:"PROOF"}),e.jsx("h3",{children:"성과 화면까지 같이 보면 구매 판단이 빨라집니다"}),e.jsx("p",{children:"애드센스 예상 수익과 기존 네이버 성과를 한 화면에 붙여, 자동화가 단순 기능이 아니라 운영 결과로 이어지는 느낌을 바로 줍니다."})]}),e.jsxs("div",{className:"proof-showcase-layout",children:[e.jsxs("figure",{className:"proof-feature-card",children:[e.jsx("img",{src:x.src,alt:x.title,loading:"lazy"}),e.jsxs("figcaption",{children:[e.jsx("span",{children:x.metric}),e.jsx("strong",{children:x.title}),e.jsx("small",{children:x.desc})]})]}),e.jsx("div",{className:"proof-mini-grid","aria-label":"애드센스 수익 인증",children:j.map(s=>e.jsxs("figure",{className:"proof-mini-card",children:[e.jsx("img",{src:s.src,alt:s.title,loading:"lazy"}),e.jsxs("figcaption",{children:[e.jsx("strong",{children:s.title}),e.jsx("small",{children:s.desc})]})]},s.src))}),e.jsx("div",{className:"proof-naver-row","aria-label":"네이버 성과 인증",children:O.map(s=>e.jsxs("figure",{className:"proof-naver-card",children:[e.jsx("img",{src:s.src,alt:s.title,loading:"lazy"}),e.jsxs("figcaption",{children:[e.jsx("span",{children:s.metric}),e.jsx("strong",{children:s.title})]})]},s.src))})]}),e.jsx("style",{children:`
                .proof-showcase {
                    width: 100%;
                    margin: 0 auto;
