...
### S13 — 꼬리 발행 직렬화 탈락 (신규, 수정 완료 96fbcf2b)
- 실측: 발행물 224312474175 — 에디터에 꼬리 전부 타이핑됨(probe 통과, PrePublish 구분선 42)인데 발행물엔 Enter 빈 문단조차 없음. 모바일 페이지 컴포넌트 33개가 마무리 문단에서 종료.
